        ...
        <>
            ...
            >
                <defs>
                    ...
                    <path fill="#fb6a4f" d="M483 54H488V59H483z" />
                    <path
                        id="b"
                        fill="#FB6A4F"
                ...
                <g>
                    <path
                        fill="#263D52"
                        d="M284.2 121.7l-1.2.1-1.3 19.6c0 6.6-3.1 12.7-10.2 12.7h-58.1c-7.1 0-11.2-6.2-11.2-12.8l-.2-19.8h-2c-.6 7-2 27.4-2 32.9 0 23.3 19.4 42.1 44.5 42.1s44.5-18.7 44.5-42c0-5.5-2.2-25.8-2.8-32.8z"
                    />
                    <path
                        fill="#263D52"
